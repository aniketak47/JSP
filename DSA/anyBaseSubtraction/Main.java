package DSA.anyBaseSubtraction;
...
public class Main {
    public static void main(String[] args) {
        ...
        int ans = getAnyBaseSubtraction(b, n1, n2);
        System.out.println("ans is : "+ ans);
    }

    public static int getAnyBaseSubtraction(int b, int n1, int n2) {
        int n1InDecimal = anyBaseToDecimal(n1, b);
        int n2InDecimal = anyBaseToDecimal(n2, b);
        int n = n2InDecimal - n1InDecimal;
